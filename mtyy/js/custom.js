...
return!isMobile}
document.addEventListener('DOMContentLoaded',function(){var myLazyLoad=new LazyLoad();myLazyLoad.update();let menuItems=document.querySelectorAll('.head-more-menu')
