...
return!isMobile}
NProgress.configure({showSpinner:!1});window.addEventListener('beforeunload',function(){NProgress.start()});window.addEventListener('load',function(){NProgress.done()});document.addEventListener('DOMContentLoaded',function(){var myLazyLoad=new LazyLoad();myLazyLoad.update();let menuItems=document.querySelectorAll('.head-more-menu')
