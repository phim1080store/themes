...
window.player=new Artplayer({container:'#player-wrapper',url:link,poster:poster,autoplay:!1,autoSize:!1,preload:'auto',pip:document.pictureInPictureEnabled||!1,loop:!1,mutex:!0,setting:!0,flip:!1,lock:!0,gesture:!1,fastForward:!1,playbackRate:!0,aspectRatio:!1,theme:'#D32F2F',fullscreen:!0,fullscreenWeb:!Artplayer.utils.isMobile,autoOrientation:!0,airplay:!0,whitelist:['*'],lang:'vi',i18n:language,controls:controls,plugins:plugins,settings:settings,layers:layers,moreVideoAttr:{crossOrigin:'anonymous',},customType:{m3u8:function(video,url){if(Hls.isSupported()){if(window.player.hls)window.player.hls.destroy()
...
window.player.hls.on(Hls.Events.ERROR,function(e,data){if(data.fatal){switch(data.type){case Hls.ErrorTypes.NETWORK_ERROR:window.player.notice.show='Mất mạng, đang thử kết nối lại...'
